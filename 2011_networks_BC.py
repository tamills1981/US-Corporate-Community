...
edges = pd.read_csv(r'data\2011_edges_BC.csv', encoding = 'latin1')
nodes = pd.read_csv(r'data\2011_nodes_BC.csv', encoding = 'latin1')
...
#Export the networks
nx.write_gpickle(bi_250_corps, 'pickled_networks/bi_250_corps_2011_BC.gpickle')
nx.write_gpickle(corporate_network_2011, 'pickled_networks/corporate_network_2011_BC.gpickle')
nx.write_gpickle(corp_dir_network_2011, 'pickled_networks/corp_dir_network_2011_BC.gpickle')

#Export the networks as Gephi Files
nx.write_gexf(bi_250_corps, 'gephi_files/bi_250_corps_2011_BC.gexf')
nx.write_gexf(corporate_network_2011, 'gephi_files/corporate_network_2011_BC.gexf')
nx.write_gexf(corp_dir_network_2011, 'gephi_files/corp_dir_network_2011_BC.gexf')
...
#Export the networks
nx.write_gpickle(bi_full, 'pickled_networks/bi_ppgs_2011_BC.gpickle')
nx.write_gpickle(ppgs_network_2011, 'pickled_networks/ppgs_network_2011_BC.gpickle')
nx.write_gpickle(ppgs_dir_network_2011, 'pickled_networks/ppgs_dir_network_2011_BC.gpickle')

#Export the networks as Gephi Files
nx.write_gexf(bi_full, 'gephi_files/bi_ppgs_2011_BC.gexf')
nx.write_gexf(ppgs_network_2011, 'gephi_files/ppgs_network_2011_BC.gexf')
nx.write_gexf(ppgs_dir_network_2011, 'gephi_files/ppgs_dir_network_2011_BC.gexf')